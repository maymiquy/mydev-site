...
export const Navigation = () => {
 ...
 return (
  <header ref={ref}>
   <nav className={`fixed inset-x-0 top-0 z-20 backdrop-blur duration-200 border-b ${isIntersecting ? "bg-zinc-900/0 border-transparent" : "bg-zincpurple-700 border-zinc-800"}`}>
