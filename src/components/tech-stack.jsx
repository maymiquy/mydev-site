...
import { TechData } from "../lib/tech";

export default function TechStack() {
 return (
  <div className="flex flex-col gap-8 items-center">
   {!!TechData.length && (
    <Tabs aria-label="Options" variant="bordered" className="flex justify-center font-bold duration-700">
      ...
      <Tab key={index} title={tech.category}>
       <Card classname={"py-6 px-10 duration-700"}>
        <div className="block justify-center space-y-2 mb-8 py-2">
         <h1 className="text-lg font-semibold text-center text-zinc-300">{tech.description}</h1>
